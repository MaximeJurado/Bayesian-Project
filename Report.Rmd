...
print(xtable(results, digits=4, align=c("c","c"), caption="Mean for the Bayesian model."))
```
...
print(xtable(results2, digits=4, align=c("c","c"), caption="Mean for the hierarchical model."))
```
